...
==> vsphere-iso: Creating floppy disk...
    ...
    vsphere-iso: Copying file: setup/gui/autounattend.xml
    vsphere-iso: Copying file: setup/setup.ps1
    vsphere-iso: Copying file: setup/cert/rootcaindio.cer
    vsphere-iso: Copying file: setup/cert/subcaindio.cer
...
==> vsphere-iso: Power on VM...
    vsphere-iso: Please shutdown virtual machine within 1h0m0s.
==> vsphere-iso: Deleting Floppy drives...
==> vsphere-iso: Deleting Floppy image...
==> vsphere-iso: Ejecting CD-ROM media...
==> vsphere-iso: Convert VM into template...
==> vsphere-iso: Clear boot order...
    vsphere-iso: Closing sessions ....
Build 'vsphere-iso' finished after 20 minutes 20 seconds.

==> Wait completed after 20 minutes 20 seconds
